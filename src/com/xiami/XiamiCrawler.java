...
public class XiamiCrawler implements Runnable {
	...
	public XiamiCrawler(String baseUrl, long startID, long maxCnt, String xmlFile)
	{
	...
	public static void main(String[] args) {
		int maxThreads = 48;
		XiamiCrawler crawler = new XiamiCrawler("http://music.baidu.com/song/", 266322598L, 1000L, "songs.json");
